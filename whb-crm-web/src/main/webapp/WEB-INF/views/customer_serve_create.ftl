			...
			<table cellspacing="15px">
				<tr>
					...
					<td><input class="easyui-combobox" id="serveType"
						name="serveType"
						data-options="panelHeight:'auto',editable:false,valueField:'dataDicValue',textField:'dataDicValue',url:'${ctx}/customer_serve/queryDataDicValueByDataDicName?dataDicName=服务类型'" />&nbsp;<font
						color="red">*</font></td>
					<td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
					<td>客户：</td>
